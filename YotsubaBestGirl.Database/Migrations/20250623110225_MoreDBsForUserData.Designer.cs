...
namespace YotsubaBestGirl.Database.Migrations
{
    ...
    [Migration("20250623110225_MoreDBsForUserData")]
    partial class MoreDBsForUserData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.AdvertisingDB", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long>("LastResetAt")
                        .HasColumnType("bigint");

                    b.Property<long>("LastViewedAt")
                        .HasColumnType("bigint");

                    b.Property<int>("RewardCountRemaining")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("t_user_advertising");
                });

            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.AppIconDB", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.HomeMemberClothesDB", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("t_user_home_member_clothes");
                });

            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.HomeMemberTapMotionDB", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("t_user_home_member_tap_motion");
                });
            ...
            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.PhotoStampDB", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.StageDB", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.WorkLineupDB", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("ExpectValue")
                        .HasColumnType("integer");

                    b.Property<int>("LottedConditionId1")
                        .HasColumnType("integer");

                    b.Property<int>("LottedConditionId2")
                        .HasColumnType("integer");

                    b.Property<int>("LottedConditionId3")
                        .HasColumnType("integer");

                    b.Property<string>("LottedRewardSeqIds1")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("LottedRewardSeqIds2")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("LottedRewardSeqIds3")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<long>("MvpCardId")
                        .HasColumnType("bigint");

                    b.Property<int>("Result")
                        .HasColumnType("integer");

                    b.Property<int>("ShortMin")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YotsubaBestGirl.Database.Entities.UserDB", b =>
                {
                    ...
                    b.Navigation("HomeMemberClothes");

                    b.Navigation("HomeMemberTapMotions");
